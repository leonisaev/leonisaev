...
buttons = [
    ...
    Button(310, button_y, 50, 50, CAYAN),
    Button(370, button_y, 50, 50, PURPLE),
    Button(430, button_y, 50, 50, BG_COLOR, "Erase", BLACK),
    Button(490, button_y, 50, 50, BG_COLOR, "Clear", BLACK),
    Button(550, button_y, 50, 50, BG_COLOR, "Fill", BLACK)
]
